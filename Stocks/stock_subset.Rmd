...
nyse2<-read_csv("http://www.wsj.com/public/resources/documents/NYSE.csv", skip=3 )
nasdaq2<-read_csv("http://www.wsj.com/public/resources/documents/Nasdaq.csv", skip=3)
```
