...
library(extrafont)
loadfonts()
data<-read_csv("/Users/michaelschmidt/Desktop/CAIC_avalanches_1981-11-01_2018-12-02.csv")
```
...
data%>%
  ...
  ggplot(aes(x=reorder(Asp,perc), y=perc))+
    ...
    xlab("")+
    ylab("")+
    labs(title="Colorado Avalanches by Aspect", subtitle = "Reported Avalanches in Colorado From 1981 through the winter of 2017")+
    theme(axis.line.y=element_blank(),
          axis.ticks.y=element_blank(),
          text=element_text( family="Source Sans Pro", size=13), 
          plot.title=element_text(face="bold"),
          plot.subtitle=element_text(size=11, color="#555555", family="Source Sans Pro Light"),
...
data%>%
  ...
  ggplot(aes(x=Elev_long, y=perc))+
    ...
    xlab("")+
    ylab("")+
    labs(title="Colorado Avalanches By Elevation Range", subtitle = "Reported Avalanches in Colorado From 1981 through the winter of 2017")+
    theme(axis.line.y=element_blank(),
          axis.ticks.y=element_blank(),
          text=element_text( family="Source Sans Pro", size=13), 
          plot.title=element_text(face="bold"),
...
data%>%
  ...
  ggplot(aes(x=reorder(Zone, perc), y=perc))+
    ...
    xlab("")+
    ylab("")+
    labs(title="Colorado Avalanches by Range", subtitle = "Reported Avalanches in Colorado From 1981 through the winter of 2017")+
    theme(axis.line.y=element_blank(),
          axis.ticks.y=element_blank(),
